...
public class Grootboek implements Comparable<Grootboek> {
    ...
    Boolean nonactief;
    Integer nummer;
    String grootboekfunctie; // Plaats op de balans (rubriek 4b, 5b, diversen, etc.)
    String grootboekRubriek; // E.g. activa, schulden, vermogen, middelen, vorderingen, kosten, omzet
    ...
    // Functie ID en grootboek rubriek ID lijken te ontbreken
